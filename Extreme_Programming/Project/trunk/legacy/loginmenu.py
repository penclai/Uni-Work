...
class Login(QDialog):
    ...
    def __init__(self):
        ...
        self.button.clicked.connect(lambda: self.login())
    ...
    def login(self):
        # data = PasswordManager_main(str(self.lineEdit_username.text()), str(self.lineEdit_password.text()))
        # PasswordManager_main.login_check(data)
        PasswordManager_main.login_check(str(self.lineEdit_username.text()), str(self.lineEdit_password.text()))
